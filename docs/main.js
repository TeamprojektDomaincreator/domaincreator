...
(() => {
  ...
  var require_header = __commonJS({
    "node_modules/dxf/lib/handlers/header.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(tuples) {
        var state;
        var header = {};
  ...
  var require_common = __commonJS({
    "node_modules/dxf/lib/handlers/entity/common.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(type, value) {
        switch (type) {
          case 5: {
            return {
              handle: value
  ...
  var require_point = __commonJS({
    "node_modules/dxf/lib/handlers/entity/point.js"(exports) {
      ...
      var TYPE = "POINT";
      exports.TYPE = TYPE;
      var process = function process2(tuples) {
  ...
  var require_vertex = __commonJS({
    "node_modules/dxf/lib/handlers/entity/vertex.js"(exports) {
      ...
      var ensureFaces = function ensureFaces2(entity) {
        ...
        if ("x" in entity && !entity.x)
          delete entity.x;
        if ("y" in entity && !entity.y)
          delete entity.y;
        if ("z" in entity && !entity.z)
          delete entity.z;
      };
      var process = function process2(tuples) {
        return tuples.reduce(function(entity, tuple) {
        ...
        return tuples.reduce(function(entity, tuple) {
          ...
          switch (type) {
            ...
            case 10:
              {
                if (status === "IDLE")
                  entity.elevation.x = parseFloat(value);
            ...
            case 20:
              {
                if (status === "IDLE")
                  entity.elevation.y = parseFloat(value);
                else if (status === "POLYLINE")
            ...
            case 73:
              {
                if (status === "IDLE" || isPolyline)
                  loop.entities[0].closed = value;
                else
                  fillDrawEntity(type, drawType, parseFloat(value));
              }
              break;
  ...
  var require_mtext = __commonJS({
    "node_modules/dxf/lib/handlers/entity/mtext.js"(exports) {
      ...
      exports.process = process;
      var assign = function assign2(entity, type, value) {
                ...
                case "AcDbXrecord":
                  {
                    if (typeof entity.mTextFlag === "undefined")
                      ...
                      entity.secondaryAttdefCount = value;
                  }
                  break;
              }
            }
  ...
  var require_denormalise = __commonJS({
    "node_modules/dxf/lib/denormalise.js"(exports) {
      ...
      var _default = function _default2(parseResult) {
        var blocksByName = parseResult.blocks.reduce(function(acc, b) {
          acc[b.name] = b;
          return acc;
        }, {});
        var gatherEntities = function gatherEntities2(entities, transforms) {
          var current = [];
            ...
            if (e.type === "INSERT") {
              ...
              for (var r = 0; r < rowCount; r++) {
                for (var c = 0; c < columnCount; c++) {
                  ...
                  current = current.concat(gatherEntities2(blockEntities, transforms2));
                }
              }
            } else {
  ...
  var require_groupEntitiesByLayer = __commonJS({
    "node_modules/dxf/lib/groupEntitiesByLayer.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(entities) {
  ...
  var require_round10 = __commonJS({
    "node_modules/dxf/lib/util/round10.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(value, exp) {
  ...
  var require_bSpline = __commonJS({
    "node_modules/dxf/lib/util/bSpline.js"(exports) {
      ...
      var _default = function _default2(t, degree, points, knots, weights) {
        var n = points.length;
  ...
  var require_createArcForLWPolyline = __commonJS({
    "node_modules/dxf/lib/util/createArcForLWPolyline.js"(exports) {
      ...
      var _default = function _default2(from, to, bulge, resolution) {
        if (!resolution) {
          resolution = 5;
        }
        var theta;
  ...
  var require_entityToPolyline = __commonJS({
    "node_modules/dxf/lib/entityToPolyline.js"(exports) {
      ...
      var interpolateBSpline = function interpolateBSpline2(controlPoints, degree, knots, interpolationsPerSplineSegment, weights) {
        var polyline = [];
      ...
      var polyfaceOutline = function polyfaceOutline2(entity) {
        var vertices = [];
        var faces = [];
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            if (v.faces) {
              ...
              if ([3, 4].includes(_face.indices.length))
                faces.push(_face);
            } else {
              vertices.push({
                x: v.x,
      ...
      var _default = function _default2(entity, options) {
        options = options || {};
        var polyline;
        if (entity.type === "LINE") {
  ...
  var require_applyTransforms = __commonJS({
    "node_modules/dxf/lib/applyTransforms.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(polyline, transforms) {
  ...
  var require_toPolylines = __commonJS({
    "node_modules/dxf/lib/toPolylines.js"(exports) {
      ...
      var _default = function _default2(parsed) {
  ...
  var require_getRGBForEntity = __commonJS({
    "node_modules/dxf/lib/getRGBForEntity.js"(exports) {
      ...
      var _default = function _default2(layers, entity) {
  ...
  var require_rotate = __commonJS({
    "node_modules/dxf/lib/util/rotate.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(p, angle) {
        return {
  ...
  var require_rgbToColorAttribute = __commonJS({
    "node_modules/dxf/lib/util/rgbToColorAttribute.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(rgb) {
  ...
  var require_insertKnot = __commonJS({
    "node_modules/dxf/lib/util/insertKnot.js"(exports) {
      ...
      exports["default"] = void 0;
      var _default = function _default2(k, controlPoints, knots, newKnot) {
        var x = knots;
        var b = controlPoints;
  ...
  var require_toPiecewiseBezier = __commonJS({
    "node_modules/dxf/lib/util/toPiecewiseBezier.js"(exports) {
      ...
      var checkPinned = function checkPinned2(k, knots) {
        for (var i = 1; i < k; ++i) {
          if (knots[i] !== knots[0]) {
      ...
      var multiplicity = function multiplicity2(knots, index) {
        var m = 1;
      ...
      var computeInsertions = function computeInsertions2(k, knots) {
        var inserts = [];
        var i = k;
      ...
      var _default = function _default2(k, controlPoints, knots) {
        checkPinned(k, knots);
  ...
  var require_transformBoundingBoxAndElement = __commonJS({
    "node_modules/dxf/lib/util/transformBoundingBoxAndElement.js"(exports) {
      ...
      var _default = function _default2(bbox, element, transforms) {
  ...
  var require_toSVG = __commonJS({
    "node_modules/dxf/lib/toSVG.js"(exports) {
      ...
      var piecewiseToPaths = function piecewiseToPaths2(k, knots, controlPoints) {
        var paths = [];
  ...
  function handleFileSelect(event) {
    ...
    reader.onload = function(event2) {
      if (typeof event2.target.result !== "string") {
        console.warn("Result was not a string!");
        return;
      }
      const h = new import_dxf.Helper(event2.target.result);
